...
const LandingPage = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-center items-center order-1 grow-0 p-0 h-screen mx-auto shadow-md overflow-hidden">
      <div className="backGround bg-no-repeat bg-cover w-full border-4 border-blue-500 m-6 rounded-lg h-full md:w-1/2 md:h-full">
        <div className="flex flex-col mt-[15%] items-center h-full">
          <h1 className="text-4xl md:text-5xl font-bold text-[#000] flex flex-col items-center text-center">
            Optimize Your Online Experience with Our Advanced
            <span className="bg-gradient-to-l text-sky-600">
              URL Shortening
            </span>
          ...
          <p className="mt-6 text-black flex flex-col items-center justify-center p-5 text-center">
            Personalize your shortened URLs to align with your brand identity.
            Utilize custom slugs, branded links, and domain customization
            options to reinforce your brand presence and enhance user
            engagement.
          </p>
          <button className="mt-6 bg-blue-700 text-[#FFF] text-lg font-bold py-3 px-6 rounded-lg md:mt-10">
            <Link href="/SignUp" className="text-xl font-bold text-[#FFF]">
              Get Started
            </Link>
          </button>
      ...
      <div className="backGround bg-no-repeat bg-cover w-full rounded-lg h-full md:w-1/2">
        <div className="flex flex-col items-center mt-10 md:mt-24 px-6">
          <input
            type="text"
            placeholder="Enter your URL to shorten"
            className="p-3 w-full md:w-96 rounded-lg border border-gray-300 outline-none mb-4"
            value={urlToShorten}
            onChange={(e) => setUrlToShorten(e.target.value)}
          />
          <button
            className="bg-blue-700 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-800 cursor-pointer w-full md:w-auto"
            onClick={handleShorten}
          >
            Shorten URL
          </button>
        ...
        <div className="flex flex-col items-center mt-8 md:mt-12 px-6">
          <h2 className="text-xl md:text-2xl font-semibold mb-4">Your Shortened URLs:</h2>
          <ul className="w-full">
            {shortenedUrls.map((url, index) => (
